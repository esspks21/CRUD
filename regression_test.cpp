...
struct Gen {
    ...
    string genRank(int sen) {
        ...
        // 임원(Master 이상) 비율: 0-4년=0%, 5-9년=0%, 10-14년=0%,
        //                        15-19년=0.5%, 20-25년=1%, 26+년=3% → 전체 평균 ~1%
        static const int W[6][11] = {
            {760, 220,  15,   5,   0,   0,   0,   0,   0,   0,   0},
            {430, 420, 125,  25,   0,   0,   0,   0,   0,   0,   0},
            {210, 390, 330,  70,   0,   0,   0,   0,   0,   0,   0},
            {120, 280, 400, 195,   3,   1,   1,   0,   0,   0,   0},
            { 60, 150, 300, 480,   5,   3,   2,   0,   0,   0,   0},
            {  0,  70, 210, 690,  14,   8,   5,   2,   1,   0,   0},
        };
